...
<div class="call-to-action text-center">
                            <span class="cta-text tv-white-text position-relative tv-offspace-right-30">Host Login</span>
                            <a href="hostlogin.php" class="button button-fill-white">Sign up now</a>
                            <br>
                            <br>
                        ...
                        if($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            $sql = "SELECT c_id FROM customers WHERE email = '$myemail' and telephone = '$mytelephone'";
                            ...
                            if($count == 1) {
                                ...
                                header("location: bookings.php"); //should direct to listings.php
                            }else {
