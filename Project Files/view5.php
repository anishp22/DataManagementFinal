    ...
    <body class="is-preload">
            ...
            <section id="banner" class="banner-area">
                <div class="container inner">
                    <div class="slide-text">
                        ...
                        <div class="content">
                            <p>List of all hosts and their vehicles that have been booked at least once</p>
                        </div>
                    </div>
                </div>
            </section>
     ...
     <section class="generic-page tv-bg-dark tv-padd-tb-80">
                    <div class="container">
                        ...
                        $sql = "SELECT v_id, hosts_id FROM vehicles UNION SELECT vehicle_id, hosts_id FROM bookings";
