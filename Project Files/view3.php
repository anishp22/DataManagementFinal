    ...
    <body class="is-preload">
            ...
            <section id="banner" class="banner-area">
                <div class="container inner">
                    <div class="slide-text">
                        ...
                        <div class="content">
                            <p>Find all vehicles above average cost.</p>
                        </div>
                    </div>
                </div>
            </section>
     ...
     <section class="generic-page tv-bg-dark tv-padd-tb-80">
                    <div class="container">
                        ...
                        $sql = "SELECT brand, model, v_year, v_type, daily_cost FROM vehicles WHERE daily_cost > (SELECT avg(daily_cost) FROM vehicles)";
