...
<html lang="en">
    ...
    <body class="is-preload">
        ...
        <div id="page">
            ...
            <form  method="POST">
            <h1>Host Create Account</h1>
            SIN: <input type = "number" name = "sinNo" style="color:black;" placeholder="Enter SIN" minlength="9" maxlength="9"required /><br>
            First Name: <input type = "text" name = "fname" style="color:black;" placeholder="Enter First Name" required /><br>
            Last Name: <input type = "text" name = "lname" style="color:black;" placeholder="Enter Last Name" required/><br>
            Address: <input type = "text" name = "address" style="color:black;" placeholder="Enter Address" required/><br>
            Phone Number: <input type = "tel" name="telephone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" style="color:black;" placeholder="000-000-0000" required/><br>
            Email: <input type="email" name="email" style="color:black;" placeholder="email@domain.xy"><br>
            VIN: <input type="number" name="vehicle_id" style="color:black;" placeholder="Enter VIN">
            <input type = "submit" name="addHost" value="Submit"/><br><br> 
